...
if (!$_POST)  {
	...
	$display_block .= "<br/>
	<p style=\"text-align: center\"><a href=\"addRecord.php?master_id=".$_POST['sel_id']."\">add info</a> ...<a href=\"".$_SERVER['PHP_SELF']."\">select another</a>...<a href='../index.html'>main menu</a></p>";
}
