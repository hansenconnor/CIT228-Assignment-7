...
END_OF_BLOCK;
	...
	mysqli_close($mysqli);
	$display_block = "<p>Your entry has been added.  Would you like to <a href=\"addRecord.php\">add another</a>?...Would you like to return to the <a href='../index.html'>main menu</a>?</p>";
}
?>
<!DOCTYPE html>
<html>
